...
void wczytaj()
{
	...
	while( m )
	{
		scanf( "%lld %lld %lld %lld", &u, &v, &b, &c ); // u, v nale¿¹ do przedzia³u [0..n-1]
		
		
		// Etap I: krawêdŸ u->v po zwyk³ej cenie, w ka¿dym egzemplarzu grafu 
		...
		// Etap II: krawêdŸ po ni¿szej cenie, z wierzcho³ka u (egzemplarz grafu nr j) do wierzcho³ka v (egzemplarz grafu nr j+1)
